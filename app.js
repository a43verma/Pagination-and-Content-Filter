...
const totalPages = Math.ceil(studentAmount/10);
...
// receive text from search button and stop it from reloading the page
// loop through each of the names in the list
//
